...
<form id="cart_form" method="post" action="index.php?controller=cart&amp;action=send" role="form">
   ...
   <div class="col-md-4 col-sm-12">
      ...
      <div class="form-group">
         <input name="tenkh" type="text" class="form-control" placeholder="Họ và tên" required="required"/>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
         <input name="sdt" type="text" class="form-control" placeholder="Số di động" required="required" pattern="[0-9]{10,11}"/>
      </div>
      <div class="form-group">
